...
rotateButton.addEventListener('click', function rotate() {
  map.firstElementChild.style.transform = "rotate(0deg)";
})
...
class Slider {
    ...
    constructor({ DOMselector, sliders }) {
        ...
        this.sliderWidth = 100;                                     // Slider width
        this.sliderHeight = 100;                                    // Slider length
    ...
    createLegendUI() {
        ...
        this.sliders.forEach((slider, index) => {
            ...
            thirdSpan.setAttribute('id', 'compassDeg');
    ...
    updateLegendUI(currentAngle) {
        ...
        // UPDATE MAP ROTATION: 
        if (currentValue > 20 && currentValue < 350) {
            //map.style.backgroundColor = "yellow";
            map.firstElementChild.style.transition = "0.1s ease-in-out";
        }
        else {
            //map.style.backgroundColor = "blue";
            map.firstElementChild.style.transition = "none";
        }
        map.firstElementChild.style.transform = `rotate(${currentValue}deg)`;
